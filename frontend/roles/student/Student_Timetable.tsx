...
// Updated Course interface with new properties
interface Course {
  name: string;
  time: string;
  day: string;
  room: string;
  code: string;        // Added property
  instructor: string;  // Added property
  credit: string;      // Added property
  faculty: string;     // Added property
}
...
const Student_Timetable = () => {
  ...
  const [courses, setCourses] = useState<Course[]>([
    { name: "Math 3020", time: "9-9:50", day: "Monday", room: "201", code: "Math 3020", instructor: "Dr. Smith", credit: "3", faculty: "Science" },
    { name: "CSE 3050", time: "9-9:50", day: "Wednesday", room: "211", code: "CSE 3050", instructor: "Prof. Jack", credit: "4", faculty: "Engineering" },
    { name: "CSE 3060", time: "10-10:50", day: "Wednesday", room: "211", code: "CSE 3060", instructor: "Prof. Hally", credit: "4", faculty: "Engineering" },
    { name: "CSE 3030", time: "3-3:50", day: "Tuesday", room: "211", code: "CSE 3030", instructor: "Dr. Johnson", credit: "3", faculty: "Engineering" },
  ]);
    ...
    <Box flex={1} bg="white" p={4}>
      ...
      {selectedView === "week" ? (
        <VStack>
          ...
          {/* Time Rows */}
          {["9-9:50", "10-10:50", "11-11:50", "1-1:50", "2-2:50", "3-3:50", "4-4:50"].map((timeSlot) => (
        ...
        <VStack space={4}>
          ...
          {courses
            ...
            .map((course, index) => (
              <Pressable
                key={index}
                onPress={() => handleCourseClick(course, course.time, course.day)}
                bg="primary.200"
                p={4}
                rounded="md"
              >
      ...
      {/* Modal for Adding or Viewing Course */}
      {newCourse ? (
        <AddCourseModal
          isOpen={isModalOpen}
